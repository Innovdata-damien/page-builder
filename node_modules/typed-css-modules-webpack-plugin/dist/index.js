...
class TypedCssModulesPlugin {
    constructor({ globPattern, postCssPlugins = cssModuleCore.defaultPlugins }) {
        ...
        this.dtsCreator = new typed_css_modules_1.default({ searchDir: __dirname, loaderPlugins: postCssPlugins });
    }
    apply(compiler) {
